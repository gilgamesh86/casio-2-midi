...
__ALIGN_BEGIN static uint8_t
    USBD_CDC_CfgDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END = {
        ...
        0x01, /* bInterfaceClass: Audio Interface Class, changed here */
        0x01, /* bInterfaceSubClass: audio Control Model changed here */
        0x00, /* bInterfaceProtocol: unused, changed here */
        0x00, /* iInterface */
